...
~~~sh
# getting the code
git clone git@github.com:nko4/sporkydorky.git && cd ./sporkydorky/

# developing
npm install
npm start

# deploying (to http://sporkydorky.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@sporkydorky.2013.nodeknockout.com
ssh root@sporkydorky.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@sporkydorky.2013.nodeknockout.com
ssh -i ./id_deploy root@sporkydorky.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/sporkydorky" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
